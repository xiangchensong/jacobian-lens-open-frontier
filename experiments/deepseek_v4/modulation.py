"""Experiment 2.2 -- directed modulation, measured at generated positions.
...
M = "/data3/fan-test/models/DeepSeek-V4-Flash-0731"
...
lens = JacobianLens.load("/data3/fan-test/jlens_out/v4flash_band_n1000_s128.pt")
BAND = lens.source_layers
J = {l: lens.jacobians[l].to("cuda:0") for l in BAND}
sys.path.insert(0, "/data3/fan-test/models/DeepSeek-V4-Flash-0731/encoding")
