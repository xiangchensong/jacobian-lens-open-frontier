"""Experiment 6.2 -- locate the workspace band by four onset/offset statistics.
...
FULL_LENS = "/data3/fan-test/jlens_out/v4flash_runAnorm_n100_s128.pt"   # layers 0..42
BAND_LENS = "/data3/fan-test/jlens_out/v4flash_runBand_n100_s128.pt"    # layers 24..42
DEV = "cuda:0"
...
def onset_offset(lens, J):
    ...
    with open(f"{SCRATCH}/exp62_stats.json", "w") as f:
        json.dump(rows, f, indent=1)
    log(f"wrote {SCRATCH}/exp62_stats.json")
...
six_set_eval(band, Jb, "v4flash_runBand_n100_s128 (L24-42)")
