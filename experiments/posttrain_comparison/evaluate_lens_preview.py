"""J-lens vs mHC-vanilla across all six lens-quality eval sets, on the preview
checkpoint -- the lens-quality control behind the readout-overlap comparison.
Path-only derivation of deepseek_v4/evaluate_lens.py; run it with the preview
band lens.

Usage: evaluate_lens_preview.py <lens.pt> [<lens2.pt> ...]
