"""Experiment 1.3 on the preview checkpoint -- what share of a concept vector's
variance lives in J-space -- plus the position-adaptive form of the 5.3 ablation
the measurement motivates. Path-only derivation of deepseek_v4/jspace_variance.py.
